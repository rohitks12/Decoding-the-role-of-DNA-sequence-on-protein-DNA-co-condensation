...
#1 and 2 : for the monomers belonging to the heterogeneous DNA I
#24 : proteins
...
set fp [open "./TypeID_hetero_I.dat" r] ;#load the input file for sequence
set index {}
set TypeID {}
