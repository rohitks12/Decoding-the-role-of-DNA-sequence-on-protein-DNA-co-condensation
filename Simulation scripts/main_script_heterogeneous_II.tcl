...
#1 and 2 : for the monomers belonging to the heterogeneous DNA II
#24 : proteins
...
#loading file
set fp [open "./TypeID_hetero_II.dat" r] ;#load the input file for sequence
set index {}
set TypeID {}
...
set epsilon_values {0.0 0.1 2.25 }
...
part $i bond 4 [expr $i-1] [expr $i+1]
}
